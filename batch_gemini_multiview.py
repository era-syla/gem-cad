"""
Batch Gemini API caller for CAD model generation from multi-view images.
Each input image contains 4 views of the same 3D object arranged in one image.

Usage:
    python batch_gemini_multiview.py --input_dir ./images --output_dir ./results
...
# Prompt
GEMINI_PROMPT = """You are an expert CAD engineer and 3D modeling specialist with deep knowledge of mechanical design, geometric modeling, and CadQuery.
...
def main():
    ...
    parser.add_argument("--suffix", type=str, default="_31_mv", help="Suffix for output .py files")
